   ...
   <?php  ?>
        ...
        <footer class="py-5">
            ...
            <div class="d-flex flex-column flex-sm-row justify-content-between py-4 my-4 border-top">
                <p>&copy; 2019 – <?php echo date('Y'); ?> The Kiddos Project. All right reserved &middot;  <a href="<?= base_url('home/privacy')?>">Privacy</a> &middot; <a href="<?= base_url('home/terms')?>">Terms</a> &middot; <small>Version 1.0</small></p> 
